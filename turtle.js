...
function createTurtle(graphicSize, bodyRadius, headRadius, feetRadius) {
	...
	cg.ellipse(graphicRadius + 10, graphicRadius, feetSize); // top right
	cg.ellipse(graphicRadius + 10, graphicRadius + 10, feetSize); // bottom right
	cg.ellipse(graphicRadius - 10, graphicRadius, feetSize); // top left
	cg.ellipse(graphicRadius - 10, graphicRadius + 10, feetSize); // bottom left
	cg.pop();
